...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'wow_gis_dialog_base_raster.ui'))


class WoWGISDialogRaster(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(WoWGISDialogRaster, self).__init__(parent)
